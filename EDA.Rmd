...
```{r}
pattern <- "(pop)|(rock)|(jazz)|(house)|(electronic)|(alternative)|(punk)|(metal)|(hip hop)|(classical)|(r&b)|(rap)|(edm)|(country)|(indie)|(folk)|(reggae)|(dance)"
...
genre_factor %>%
  filter(is.na(super_genre))

summary(genre_factor$super_genre)
